			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
					...
					<%-- 		<%
							...
							<ul class="pagination">
								 <li class="prev"><a
									href="/user/pagingUser?page=1&pageSize=${pageVo.getPageSize()}">«</a>
								</li> 
						<%-- 		<%
								...
								<c:forEach begin="1" end="${pagination }" var="i">
									...
									<c:choose>
										...
										<c:otherwise>
											<li><a
												href="/user/pagingUser?page=${i }&pageSize=${pageVo.getPageSize()}">${i }</a></li>
										</c:otherwise>
								...
								<li class="next"><a
									href="/user/pagingUser?page=${pagination}&pageSize=${pageVo.getPageSize()}">»</a>
								</li> 
							</ul>
						</div>
					</div>
