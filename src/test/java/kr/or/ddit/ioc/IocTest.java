...
public class IocTest {
	...
	public void beanScopeTest() {
		...
		// 디자인 패턴의 singleton 개념으로 보면 두개의 객체는 한 클래스로부터 나왔으므로 동일 해야함
	...
	public void beanScopeTest2() {
		...
		// 동일한 스프링 빈을 주입 받았으므로 userService, userService2는 같은 객체다.
	...
	public void beanScopePrototypeTest2() {
		...
		// 동일한 userServicePrototype 빈을 줍입 (scope : prototype)
	...
	public void propertyPlaceholderTest() {
		...
		assertEquals("pc21", dbConfig.getUsername());
